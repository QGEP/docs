...
.. Note:: The SQL related to these roles is stored `here <https://github.com/QGEP/datamodel/blob/master/12_0_roles.sql>`_ and `here <https://github.com/QGEP/datamodel/blob/master/12_1_roles.sql>`_
